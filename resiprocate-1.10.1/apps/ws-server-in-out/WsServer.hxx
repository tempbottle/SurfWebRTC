...
#define MAX_IPADDRESS_LENGTH 16
...
private:
   ...
   ServerInviteSessionHandle mSisCaller;
   ClientInviteSessionHandle mCisCallee;
   SdpContents *mSdpCaller;
   InviteSessionHandle mInviteSessionHandleCaller;   
   InviteSessionHandle mInviteSessionHandleCallee;   
   char targetIP[MAX_IPADDRESS_LENGTH];
